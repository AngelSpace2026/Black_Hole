...
def find_best_chunk_strategy(input_filename, max_consecutive_no_improvements=360000, max_time_seconds=360000, max_iterations=1000000):
    ...
    with tqdm(total=max_iterations, desc="Searching for best compression") as pbar:  # Progress bar
