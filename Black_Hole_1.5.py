...
import math
import paq  # Importing PAQ compression library
...
# Function to compress and embed chunk size using PAQ
def compress_reversed(reversed_filename, compressed_filename, chunk_size):
    ...
    compressed_data = paq.compress(chunk_size_bytes + reversed_data)  # Using PAQ instead of Zstd
...
def decompress_and_restore(compressed_filename, restored_filename):
    ...
    decompressed_data = paq.decompress(compressed_data)  # Using PAQ decompression
