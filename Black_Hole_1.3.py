...
if os.path.basename(sys.argv[0]) != 'Black_Hole_1.3.py':

    sys.exit("This is not 'Black_Hole_1.3.py'.")

print("The script 'Black_Hole_1.3.py' is currently running.")
                                        ...
                                        if (C3 >= 6 and En <= (2 ** (C3 - 4) - 1)) or INFO_A[:3] in {"011", "010"}:
                                            ...
                                            if C3 != 1:
                                                ...
                                                if random_number==0:
                                                    ...
                                                    C_transposed = [[C[j][i] for j in range(len(C))] for i in range(len(C[0]))]
