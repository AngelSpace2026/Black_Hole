...
def find_best_iteration(input_filename, max_iterations):
    ...
    for iteration in range(max_iterations):
        ...
        strategy = (iteration % 4) + 1  # Cycle through strategies (1,2,3,4)
...
def run_compression(input_filename):
    ...
    # Skip compression if file is smaller than 2 KB
    if file_size < 2048:
        print(f"Skipping compression. File '{input_filename}' is less than 2 KB.")
        return None
