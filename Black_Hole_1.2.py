...
if os.path.basename(sys.argv[0]) != 'Black_Hole_1.2.py':

    sys.exit("This is not 'Black_Hole_1.2.py'.")

print("The script 'Black_Hole_1.2.py' is currently running.")
